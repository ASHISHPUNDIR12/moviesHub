...
const SmallMovieCard = ({ title, year, imageId,rating }: SmallMoviesCardInterface) => {
  ...
  return (
    <div>
      <div className="flex border-b border-blue-950 p-2 gap-30 m-1 scroll-m-0 hover:bg-indigo-300/20 rounded ">
        <div className="w-16">
          <img
